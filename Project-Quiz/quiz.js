  ...
  function showresult(count) {
   ...
   if (rightanswercount > (count / 2) && rightanswercount < count) {
      result = "<span class='good'> Good </span>:" + rightanswercount + " from " + count + " is good answers ."
   } else if (rightanswercount == count) {
      result = "<span class='perfect'> perfect </span>:" + rightanswercount + " from " + count + " is perfect answers ."
   } else {
      result = "<span class='bad'> Bad </span>:" + rightanswercount + " from " + count + " is bad answers ."
   }
